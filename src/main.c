...
/*   Updated: 2025/01/19 16:25:52 by mbaj             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	minishell_loop(t_data **minishell)
{
	while (1)
	{
		...
		{
			perror((*minishell)->tokens->value);
			// execute_commands(minishell);
			//check_path((*minishell)->commands, (*minishell)->env);
			check_type((*minishell)->commands, minishell, (*minishell)->env);
		}
	}
}
